...
$filter_property = $_GET['filter-property'] ?? null;
$filter_number = $_GET['filter-number'] ?? null;
// $filter_furnished = $_GET['filter-furnished'];
// $filter_price_from = $_GET['filter-price-from'];
// $filter_price_to = $_GET['filter-price-to'];
$filter_area_from = $_GET['filter-area-from'] ?? null;
$filter_area_to = $_GET['filter-area-to'] ?? null;
