...
<main>
        <div class="breadcrumbs">
            <div class="container">
                <ul>
                    <li>
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>">Головна</a>- <a href="<?php echo esc_url( home_url( '/newse' ) ); ?>">Новини</a>- <span><?= get_the_title(); ?></span>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="news-images-slider">
                    <div class="swiper gallery-swiper">
                        <div class="swiper-wrapper">
                          <?php if ( have_rows( 'galereya-sn' ) ) : ?>
                            <?php while ( have_rows( 'galereya-sn' ) ) : the_row(); ?>
                            <div class="swiper-slide">
                              <div class="gallery-details">
                                  <?php if ( get_sub_field( 'zobrazhennya-galereya-sn' ) ) : ?>
                                    <div class="gallery-img">
                                      <img src="<?php the_sub_field( 'zobrazhennya-galereya-sn' ); ?>" alt="gallery-img" loading="lazy">
                                    </div>
                                  <?php endif ?>
                              </div>
                            </div>
